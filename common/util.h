...
public:
    ...
    static std::string Bin2Hex(const uint8_t* buf, const size_t& len, const size_t& char_per_line = 32, const bool& printf_ascii = true, const std::string& prefix = "");
    static std::string Bin2Hex(const std::string& str, const size_t& char_per_line = 32, const bool& printf_ascii = true, const std::string& prefix = "");
    ...
    static std::vector<std::string> SepStr(const std::string& input, const std::string& sep);
	static void Replace(std::string& input, const std::string& from, const std::string& to);
