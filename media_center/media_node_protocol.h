...
private:
    int OnStreamRegisterReq(const StreamRegisterReq& stream_register_req);
    int OnGetAppStreamMasterNodeReq(const GetAppStreamMasterNodeReq& get_app_stream_master_node_req);
