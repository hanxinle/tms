...
Any::operator Double*() { return (dynamic_cast<Double*>(this)); }

Any::operator String*() { return (dynamic_cast<String*>(this)); }

Any::operator Vector*() { return (dynamic_cast<Vector*>(this)); }
...
String& Any::ToString() const { return *((String*)this); }
...
Any* Any::operator[](const std::string& key) { return ToMap()[key]; }
