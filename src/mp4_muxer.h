...
class Mp4Muxer {
 ...
 public:
  ...
  void WriteMovieBox(BitStream& bs, const PayloadType& payload_type);
  ...
  void WriteSampleDescriptionBox(BitStream& bs,
                                 const PayloadType& payload_type);
  ...
  void WriteDecodingTimeToSampleBox(BitStream& bs,
                                    const PayloadType& payload_type);
  void WriteCompositionTimeToSampleBox(BitStream& bs,
                                       const PayloadType& payload_type);
