...
private:
    ...
    void OnH264Video(BitBuffer& bit_buffer, const uint32_t& pts, const uint32_t& dts);
    void OnH265Video(BitBuffer& bit_buffer, const uint32_t& pts, const uint32_t& dts);
